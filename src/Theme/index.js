...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#1a74ff' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#1a74ff',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#1a74ff',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#1a74ff',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #1a74ff30 0%, #fff 0%)`,
})
